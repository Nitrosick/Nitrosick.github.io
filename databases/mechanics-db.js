...
const tableOfContent = `
	...
	<a class="link" href="mechanics-page-3.html#mob_skills" id="link15">			15. Способности юнитов</a>
		...
		<a class="sublink" href="mechanics-page-3.html#mob_skills.9" name="link15">	15.9 Виверны-монархи, Морские змеи и Аспиды: Яд</a>
	...
	<a class="link" href="mechanics-page-4.html#grail" id="link19">					19. Грааль</a>
		<a class="sublink" href="mechanics-page-4.html#grail.1" name="link19">		19.1 Раскопки Грааля</a>
		<a class="sublink" href="mechanics-page-4.html#grail.2" name="link19">		19.2 Храм Грааля</a>
	<a class="link" href="mechanics-page-4.html#fortification" id="link20">			20. Фортификационные укрепления города и их штурм</a>
		<a class="sublink" href="mechanics-page-4.html#fortification.1" name="link20">20.1 Городские стены</a>
		<a class="sublink" href="mechanics-page-4.html#fortification.2" name="link20">20.2 Стрелковые башни</a>
		<a class="sublink" href="mechanics-page-4.html#fortification.3" name="link20">20.3 Ров и его аналоги</a>
`;
...
const tableOfContentM = `
	...
	<details class="story-list-part">
		...
		<ul>
			...
			<li class="story-link"><a href="mechanics-page-m-3.html#mob_skills.9">	15.9 Виверны-монархи, Морские змеи и Аспиды: Яд</a></li>
	...
	<details class="story-list-part">
		<summary>19. Грааль</summary>
		<ul>
			<li class="story-link"><a href="mechanics-page-m-4.html#grail.1">		19.1 Раскопки Грааля</a></li>
			<li class="story-link"><a href="mechanics-page-m-4.html#grail.2">		19.2 Храм Грааля</a></li>
		</ul>
	</details>
	<details class="story-list-part">
		<summary>20. Фортификационные укрепления города и их штурм</summary>
		<ul>
			<li class="story-link"><a href="mechanics-page-m-4.html#fortification.1">20.1 Городские стены</a></li>
			<li class="story-link"><a href="mechanics-page-m-4.html#fortification.2">20.2 Стрелковые башни</a></li>
			<li class="story-link"><a href="mechanics-page-m-4.html#fortification.3">20.3 Ров и его аналоги</a></li>
		</ul>
	</details>
`;
...
const separateTables = {
	...
	<table class="compress">
		...
		<tr> <td>Чёрт</td> <td>60</td> 					<td>Воздушный элементаль</td> <td>324</td> 		<td>Циклоп</td> <td>1055</td> </tr>
	...
	<table>
		...
		<tr> <td>Чёрт</td> <td>60</td> 					 <td>Вампир</td> <td>518</td> </tr>
	...
	<tr> <td>Чёрт</td> <td>4</td> 					<td>Медуза-королева</td> <td>15</td> 			<td>Огр-маг</td> <td>25</td> </tr>
	...
	<tr> <td>Чёрт</td> <td>4</td> 					<td>Мечник</td> <td>20</td> </tr>
	...
	spellsSpecialize: `
	<table>
		<tr> <th>Специализация</th> 	<th>Герой</th> 							<th>Описание</th> </tr>
		...
		<tr> <td>Цепная молния</td> 	<td>Солмир</td> 						<td class="left">Специализация увеличивает урон <mark>Цепной молнии</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Расчёт производится для каждого существа, на которого подействовала <mark>Цепная молния</mark>, причём сначала производится расчёт базового урона для каждой цели, а затем только он модифицируется по указанной ниже формуле. Формула расчёта урона заклинания для экспертного уровня <strong>Магии воздуха</strong>:<br><mark class="tab"></mark><strong>Урон = (СМ * 40 + 100) * (1 + [N / n] * 0,03)</strong></td> </tr>
	</table>
	`,

	spellsSpecializeM: `
	<table>
		<tr> <th>Специализация</th> <th>Герой</th> </tr>
		<tr> <td>Благословение</td> 	<td>Адель</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает урон существа, на которого наложено <mark>Благословение</mark>, на <strong>3%</strong> за каждый уровень героя, кратный уровню этого существа. Формула расчета урона цели для экспертного уровня <strong>Магии воды</strong>:<br>- Если атака нападающего превышает защиту атакуемого:<br><mark class="tab"></mark><strong>Урон цели = (Dmax + 1) * (1 + (Атака - Защита) * 0,05 + [N / n] * 0,03).</strong><br>- Если защита атакуемого превышает атаку нападающего:<br><mark class="tab"></mark><strong>Урон цели = (Dmax + 1) * (1 + (Атака - Защита) * 0,025) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Воздушный щит</td> 	<td>Даргем</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает эффективность <mark>Воздушного щита</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Формула расчета эффекта <mark>Воздушного щита</mark> для экспертного уровня <strong>Магии воздуха</strong>:<br><mark class="tab"></mark><strong>Снижение урона = 50% * (1 + [N / n] * 0,03)</strong><br>Максимальная эффективность специализации достигается при достижении <strong>100%</strong>-ного снижения урона (не ниже 1).</td> </tr>
		<tr> <td>Волна смерти</td> 		<td>Септиенна</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает урон <mark>Волны смерти</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Расчёт производится для каждого существа, на которого подействовала <mark>Волна смерти</mark>. Формула расчета урона заклинания для экспертного уровня <strong>Магии земли</strong>:<br><mark class="tab"></mark><strong>Урон = (СМ * 5 + 30) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Воскрешение</td> 		<td>Аламар, Джеддит</td>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Воскрешения</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню воскрешаемого существа. Формула расчёта силы <mark>Воскрешения</mark> (в единицах здоровья) для экспертного уровня <strong>Магии земли</strong>:<br><mark class="tab"></mark><strong>Ед.здоровья = (СМ * 50 + 160) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Гипноз</td> 			<td>Астрал</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Гипноза</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Сила заклинания определяет максимальное количество здоровья целевого отряда, на который он сможет подействовать. Формула расчёта силы <mark>Гипноза</mark> (максимальное количество здоровья) для экспертного уровня <strong>Магии воздуха</strong>:<br><mark class="tab"></mark><strong>Ед.здоровья = (СМ * 25 + 50) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Жажда крови</td> 		<td>Аш, Интей</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Жажды крови</mark> на 1...3 единицы, в зависимости от уровня целевого существа. Зависимость силы <mark>Жажды крови</mark> от уровня цели для экспертного уровня <strong>Магии огня</strong>:<br>- Существа 1 и 2 уровня - <strong>Атака +9</strong> (в том числе эффект специализации <strong>+3</strong>);<br>- Существа 3 и 4 уровня - <strong>Атака +8</strong> (в том числе эффект специализации <strong>+2</strong>);<br>- Существа 5 и 6 уровня - <strong>Атака +7</strong> (в том числе эффект специализации <strong>+1</strong>);<br>- Существа 7 уровня - <strong>Атака +6</strong> (нет эффекта специализации).</td> </tr>
		<tr> <td>Забывчивость</td> 		<td>Зилар</td> </tr>
		<tr> <td class="left" colspan="2">Увеличивает длительность заклинания <mark>Забывчивость</mark> вдвое.</td> </tr>
		<tr> <td>Инферно</td> 			<td>Ксирон</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает урон <mark>Инферно</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Расчёт производится для каждого существа, на которого подействовало <mark>Инферно</mark>. Формула расчёта урона заклинания для экспертного уровня <strong>Магии огня</strong>:<br><mark class="tab"></mark><strong>Урон = (СМ * 10 + 80) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Каменная кожа</td> 	<td>Кси, Дарксторн, Мерист, Лабета</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Каменной кожи</mark> на 1...3 единицы, в зависимости от уровня целевого существа. Зависимость силы <mark>Каменной кожи</mark> от уровня цели для экспертного уровня <strong>Магии земли</strong>:<br>- Существа 1 и 2 уровня - <strong>Защита +9</strong> (в том числе эффект специализации <strong>+3</strong>);<br>- Существа 3 и 4 уровня - <strong>Защита +8</strong> (в том числе эффект специализации <strong>+2</strong>);<br>- Существа 5 и 6 уровня - <strong>Защита +7</strong> (в том числе эффект специализации <strong>+1</strong>);<br>- Существа 7 уровня - <strong>Защита +6</strong> (нет эффекта специализации).</td> </tr>
		<tr> <td>Клон</td> 				<td>Эоваций</td> </tr>
		<tr> <td class="left" colspan="2">Первое колдовство заклинания <mark>Клон</mark> за битву создаёт 2 копии целевого отряда. Если может быть вызван только один <mark>Клон</mark>, то вызывается один и способность считается сработавшей.</td> </tr>
		<tr> <td>Кольцо холода</td> 	<td>Аделаида</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает урон <mark>Кольца холода</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Расчёт производится для каждого существа, на которого подействовало <mark>Кольцо холода</mark>. Формула расчёта урона заклинания для экспертного уровня <strong>Магии воды</strong>:<br><mark class="tab"></mark><strong>Урон = (СМ * 10 + 60) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Ледяная молния</td>	<td>Алагар</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает урон <mark>Ледяной молнии</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Формула расчёта урона <mark>Ледяной молнии</mark> для экспертного уровня <strong>Магии воды</strong>:<br><mark class="tab"></mark><strong>Урон = (СМ * 20 + 50) * (1 + [N / n] * 0,03)</strong><br>При расчёте урона <mark>Ледяной молнии Алагара</mark> следует учесть, что он изначально имеет вторичный навык <strong>Волшебство</strong>. Поэтому, в зависимости от уровня его развития, фактический урон <mark>Ледяной молнии</mark> будет увеличен на <strong>5...15%</strong>.</td> </tr>
		<tr> <td>Лечение</td> 			<td>Уланд, Астра</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Лечения</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню излечиваемого существа. Формула расчёта силы <mark>Лечения</mark> (в единицах здоровья) для экспертного уровня <strong>Магии воды</strong>:<br><mark class="tab"></mark><strong>Ед.здоровья = (СМ * 5 + 30) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Волшебная стрела</td> 	<td>Циель</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает итоговый урон <mark>Волшебной стрелы</mark> на <strong>50%</strong>.</td> </tr>
		<tr> <td>Метеоритный дождь</td> <td>Эйслин, Димер</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает урон <mark>Метеоритного дождя</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Расчёт производится для каждого существа, на которого подействовал <mark>Метеоритный дождь</mark>. Формула расчёта урона заклинания для экспертного уровня <strong>Магии земли</strong>:<br><mark class="tab"></mark><strong>Урон = (СМ * 25 + 100) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Молитва</td> 			<td>Лойнис</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Молитвы</mark> на 1...3 единицы, в зависимости от уровня целевого существа. Зависимость силы <mark>Молитвы</mark> от уровня цели для экспертного уровня <strong>Магии воды</strong>:<br>- Существа 1 и 2 уровня - <strong>Атака</strong>, <strong>Защита</strong> и <strong>Скорость +7</strong> (в том числе эффект специализации <strong>+3</strong>);<br>- Существа 3 и 4 уровня - <strong>Атака</strong>, <strong>Защита</strong> и <strong>Скорость +6</strong> (в том числе эффект специализации <strong>+2</strong>);<br>- Существа 5 и 6 уровня - <strong>Атака</strong>, <strong>Защита</strong> и <strong>Скорость +5</strong> (в том числе эффект специализации <strong>+1</strong>);<br>- Существа 7 уровня - <strong>Атака</strong>, <strong>Защита</strong> и <strong>Скорость +4</strong> (нет эффекта специализации).</td> </tr>
		<tr> <td>Огненный шар</td> 		<td>Ксарфакс, Манфред</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает урон <mark>Огненного шара</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Расчёт производится для каждого существа, на которого подействовал <mark>Огненный шар</mark>. Формула расчёта урона заклинания для экспертного уровня <strong>Магии огня</strong>:<br><mark class="tab"></mark><strong>Урон = (СМ * 10 + 60) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Поднять мертвецов</td> <td>Тант</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Поднятия мертвецов</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню оживляемого существа. Формула расчёта силы <mark>Поднятия мертвецов</mark> (в единицах здоровья) для экспертного уровня <strong>Магии земли</strong>:<br><mark class="tab"></mark><strong>Ед.здоровья = (СМ * 50 + 160) * (1 + [N / n] * 0,03)</strong></td> </tr>
		<tr> <td>Палач</td> 			<td>Короний</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Палача</mark> на 1…4 единицы, в зависимости от уровня целевого существа. Зависимость силы <mark>Палача</mark> от уровня цели для экспертного уровня <strong>Магии огня</strong>:- Существа 1 уровня - <strong>Атака +12</strong> (в том числе эффект специализации <strong>+4</strong>);<br>- Существа 2 уровня - <strong>Атака +11</strong> (в том числе эффект специализации <strong>+3</strong>);<br>- Существа 3 уровня - <strong>Атака +10</strong> (в том числе эффект специализации <strong>+2</strong>);<br>- Существа 4 уровня - <strong>Атака +9</strong> (в том числе эффект специализации <strong>+1</strong>);<br>- Существа 5, 6 и 7 уровня - <strong>Атака +8</strong> (нет эффекта специализации).</td> </tr>
		<tr> <td>Разрушающий луч</td> 	<td>Анаин</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Разрушающего луча</mark> на 2 единицы.</td> </tr>
		<tr> <td>Слабость</td> 			<td>Катберт, Олема, Мирланда</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Слабости</mark> на 1...3 единицы, в зависимости от уровня целевого существа. Зависимость силы <mark>Слабости</mark> от уровня цели для экспертного уровня <strong>Магии воды</strong>:<br>- Существа 1 и 2 уровня - <strong>Атака -9</strong> (в том числе эффект специализации <strong>-3</strong>);<br>- Существа 3 и 4 уровня - <strong>Атака -8</strong> (в том числе эффект специализации <strong>-2</strong>);<br>- Существа 5 и 6 уровня - <strong>Атака -7</strong> (в том числе эффект специализации <strong>-1</strong>);<br>- Существа 7 уровня - <strong>Атака -6</strong> (нет эффекта специализации).</td> </tr>
		<tr> <td>Стена огня</td> 		<td>Луна</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает итоговый урон <mark>Стены огня</mark> на <strong>100%</strong>.</td> </tr>
		<tr> <td>Точность</td> 			<td>Зубин</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Точности</mark> на 1...3 единицы, в зависимости от уровня целевого существа. Зависимость силы <mark>Точности</mark> от уровня цели для экспертного уровня <strong>Магии воздуха</strong>:<br>- Существа 1 и 2 уровня - <strong>Атака +9</strong> (в том числе эффект специализации <strong>+3</strong>);<br>- Существа 3 и 4 уровня - <strong>Атака +8</strong> (в том числе эффект специализации <strong>+2</strong>);<br>- Существа 5 и 6 уровня - <strong>Атака +7</strong> (в том числе эффект специализации <strong>+1</strong>);<br>- Существа 7 уровня (<mark>Титан</mark>) - <strong>Атака +6</strong> (нет эффекта специализации).</td> </tr>
		<tr> <td>Удача</td> 			<td>Мелодиа, Дейрмиф</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Удачи</mark> до максимума - <strong>+3</strong> к <strong>Удаче</strong> целевого существа, не зависимо от уровня развития <strong>Магии воздуха</strong>. Максимальная <strong>Удача</strong> существа не может быть больше <strong>+3</strong> единиц (шанс <strong>12,5%</strong>).</td> </tr>
		<tr> <td>Ускорение</td> 		<td>Кира, Терек, Брисса</td> </tr>
		<tr> <td class="left" colspan="2">Специализация усиливает эффект <mark>Ускорения</mark> на 1...3 единицы, в зависимости от уровня целевого существа. Зависимость силы <mark>Ускорения</mark> от уровня цели для экспертного уровня <strong>Магии воздуха</strong>:<br>- Существа 1 и 2 уровня - <strong>Скорость +8</strong> (в том числе эффект специализации <strong>+3</strong>);<br>- Существа 3 и 4 уровня - <strong>Скорость +7</strong> (в том числе эффект специализации <strong>+2</strong>);<br>- Существа 5 и 6 уровня - <strong>Скорость +6</strong> (в том числе эффект специализации <strong>+1</strong>);<br>- Существа 7 уровня - <strong>Скорость +5</strong> (нет эффекта специализации).</td> </tr>
		<tr> <td>Цепная молния</td> 	<td>Солмир</td> </tr>
		<tr> <td class="left" colspan="2">Специализация увеличивает урон <mark>Цепной молнии</mark> на <strong>3%</strong> за каждый уровень героя, кратный уровню целевого существа. Расчёт производится для каждого существа, на которого подействовала <mark>Цепная молния</mark>, причём сначала производится расчёт базового урона для каждой цели, а затем только он модифицируется по указанной ниже формуле. Формула расчёта урона заклинания для экспертного уровня <strong>Магии воздуха</strong>:<br><mark class="tab"></mark><strong>Урон = (СМ * 40 + 100) * (1 + [N / n] * 0,03)</strong></td> </tr>
	</table>
	`,
...
const mechanicsContent = [
	...
	<p>
		...
		[t]Кроме того, максимальное эффективное значение любого первичного навыка равно 99 единицам, однако дальнейшее повышение возможно до 127 единиц (учитываться и отображаться будет 99). После 127 произойдёт сброс параметров [s]Атаки[/s] и [s]Защиты[/s] на 0.
	</p>
	...
	<p>
		...
		[t]Если существо производит [s]Двойной удар[/s] (например [m]Крестоносец[/m], [m]Налётчик[/m] или [m]Ассида[/m]), то [s]Удача[/s] определяется для каждого из ударов отдельно.<br><br>
	...
	<p>
		...
		[t]&bull; Если армия героя состоит из существ трёх и более разных фракций, то [s]-1[/s] от Боевого духа за каждый тип фракции. Все нейтральные существа считаются представителями одной фракции.
	</p>
	`},
	{id: 'archery', text: `
	<h1>Стрельба</h1>
	...
	<p>
		[t]Фортификационные укрепления на поле боя занимают определённые гексы. Некоторые части укреплений ([s]Ворота[/s], 4 элемента [s]Стены[/s]) могут быть разрушены, а другие - нет.<br><br>
		[t]Однако не всегда стены города обеспечивают существам за ними защиту от вражеских выстрелов. Это связано со сложной механикой гексагонального поля боя. На самом деле гексагональное поле в расчётах преобразуется в обычное клеточное и выглядит следующим образом${!m?'':' ([s]Изображения в следующих блоках можно пролистывать[/s])'}:
	</p>
	...
	<p>
		...
		[t]&bull; При наличии Базовой [s]Тактики[/s] атакующий герой может расположить войска в пределах трёх рядов: [s]1, 2[/s] и [s]3[/s]; при Продвинутой [s]Тактике[/s] - [s]1, 2, 3, 4[/s] и [s]5[/s]; при Экспертной [s]Тактике[/s] - [s]1, 2, 3, 4, 5, 6[/s] и [s]7[/s].<br><br>
	...
	<p>
		...
		[t]&bull; По клетке [s]А15[/s] (позиция [s]1[/s] в армии обороняющегося) теперь можно попасть без штрафа за стрельбу через крепостные стены с клеток [s]З1[/s] ([m]Катапульту[/m] придётся уничтожить), [s]Ж3, Е5[/s] или [s]Д7[/s].<br>
	...
	<p>
		...
		[t]По данной <a href="downloads/trajectory.xlsx" download>[m]ссылке[/m]</a> можно скачать Excel файл с полной таблицей случаев, когда стрелок на определённой клетке ([s]строки таблицы[/s]) не будет иметь штрафа за препятствия при выстреле по цели ([s]столбцы таблицы[/s]).<br><br>
		[t]&bull; [s]Жёлтые[/s] клетки со знаком "[s]Х[/s]" показывают отсутствие штрафа за препятствия.<br>
		[t]&bull; [s]Белые[/s] клетки со знаком "[s]Х[/s]" - теоретические комбинации, которые на практике не работают в связи с внутренними округлениями программы при расчётах. В остальных случаях (белые клетки или отсутствующие комбинации) штраф у стрелков есть.
	</p>
	...
	<p>
		...
		[t]Также этому правилу не подчиняется случай, когда герой посещает с дороги объект не вставая на клетку посещения (например [s]Таверну[/s]), под которой нет дороги. Т.е. герой остаётся на дороге, но затраты хода считаются по той местности, на которой находится объект.<br><br>
		[t][s]Мосты[/s], соединяющие части какой-либо дороги, являются декоративными объектами и не снижают затраты на перемещение по их клеткам, если автор карты под ними не провёл дорогу. При случайной генерации [s]Мосты[/s] не встречаются.<br><br>
	...
	<p>
		...
		[t]&bull; ИИ-герои в бою не используют тактические приёмы существ, не ждут и всегда идут в атаку;<br>
	...
	<p>
		[t]Расчёт этого бонуса производится следующим образом: ежедневно рассчитывается доход компьютерного игрока по всем видам ресурсов и считается бонус, применительно к величине его недельного дохода (если доход отсутствует, бонус не начисляется). Распределяется бонус равномерно по всей неделе.<br><br>
	...
	<table class="split">
		...
		<tr> <td>${!m?'[t]':''}[s]Разведка, Некромантия, Обучение[/s]</td> <td>[s]Х = ((1000 + ArmyPower) * 0,05)[/s]</td> </tr>
	...
	<p>
		...
		[t][s]theStrongestSpellEfficiencyDelta[/s] - разница между эффективностью самого сильного заклинания, имеющегося у героя, с прибавкой +1 к [s]СМ[/s] и +1 к длительности и без прибавки. По расчёту это могут быть два разных заклинания, а также разница не может быть меньше 10.<br><br>
	...
	<p>
		...
		[t][s]DamageResistance = 1[/s] для существ полностью защищённых от заклинания; [s]DamageResistance = 0,2 / 0,4 / 0,2[/s] для [m]Гномов[/m], [m]Боевых гномов[/m] и [m]Кристаллических драконов[/m] соответственно.<br><br>
	...
	<p>
		[t]где [s]theStrongestSpellEfficiencyDelta2 = [1 / 3 * ([theStrongestSpellEfficiencyDelta[/s] (с учётом прибавки +30 к Запасу маны героя) [s]] - [theStrongestSpellEfficiencyDelta[/s] (без прибавки) [s]])[/s].
	</p>
	<table class="split">
	...
	<p>
		[t]theStrongestSpellEfficiencyDelta3 - разница между эффективностью самого сильного заклинания, имеющегося у героя, с учётом полученного навыка и без его учёта.
	</p>
	<table class="split">
	...
	<p>
		...
		[t]&bull; Перед каждой битвой с участием ИИ, алгоритм вычисляет соотношение сил армий, причём, чем ближе оно к 1, тем большее число сопоставляет компьютер. То есть он рассматривает эту величину приблизительно как ожидаемую продолжительность битвы (её решающей фазы).<br><br>
	...
	<p>
		...
		[t]а) Войдёт этим существом в зону досягаемости существ игрока, атаковав какую-нибудь цель.<br>
		...
		[t]&bull; Существа ИИ всегда идут к ближайшему отряду (считается по количеству ходов, а не клеток, причем по текущей скорости, с учётом наложенных заклинаний) - на этом основаны действия ИИ при использовании заклинаний: если ИИ видит, что он может использовать [m]Ускорение[/m] на свой отряд и он достанет до вражеского существа, чтобы атаковать его, ИИ будет колдовать, иначе он может, например, использовать [m]Волшебную стрелу[/m] или [m]Каменную кожу[/m]. Таким образом можно вынуждать ИИ использовать определенные заклинания.<br><br>
		[t]&bull; При нескольких вражеских отрядах в зоне досягаемости, ИИ выбирает цель исходя из следующих приоритетов:<br><br>
		[t]а) Сила ответного удара (расчёт ведётся по текущему количеству существ в потенциальном атакуемом отряде, а не от того, сколько должно остаться после удара): ИИ старается выбрать минимальное значение.<br>
		[t]б) Учитывает своё текущее положение в битве (выигрышное или проигрышное положение): Если ИИ считает, что сможет выиграть, то атакует отряды, расположенные ниже. При проигрышном положении ИИ начинает с верхних.<br>
		...
		[t]&bull; [m]Стена огня[/m]. Нейтралы её прекрасно видят и легко обходят, если есть такая возможность. Иногда нейтралы могут сменить приоритетную цель атаки, если к первой цели мешает подойти [m]Стена огня[/m].<br><br>
		[t]&bull; Например, если отряд игрока достаёт до какого-нибудь отряда ИИ, то подставиться под него ИИ не считает неправильным (т. к. он в любом случае ударит какой-нибудь отряд).<br><br>
		[t]&bull; Если какой-то отряд игрока ни до кого не доходит в этот раунд, то ИИ будет минусовать урон от этого отряда из ценности удара ИИ по тем существам игрока, при ударе по которым он подставится под этот отряд игрока. При этом из выражения (Кол-во существ * [s]Fight Value[/s]) (отряда игрока, по которому планируется удар) напрямую вычитается ценность урона (от другого отряда игрока, под который ИИ может подставиться, ударив первый отряд), т.е., ценность тех существ, которые умирают от этого урона (их количество может быть дробным). А ценность 1 существа - уже есть [s]Fight Value[/s]. При этом даётся плюс к ценности, если верхнее существо в отряде с небольшим количеством здоровья и оно убивается.<br><br>
		[t]Ценность убийства существа основывается на его [s]Fight Value[/s] - параметре, привязанном к каждому существу в игре и использующемуся для расчета боевых действий ИИ. (В целом параметр [s]Fight Value[/s] (Боевая ценность существ) определяет силу существа в числовом значении. Точное значение боевой ценности существ прописаны в таблице ниже. Плюс идёт учёт ряда динамических факторов - усиливающие отряд заклинания и прочее. Ответный удар считается от оставшегося после удара отряда исходя из среднего урона.
	</p>
	...
	<p>
		[t]Указанные в таблице приоритеты справедливы в том случае, когда Ваши существа смогут дойти до вражеских за одинаковое количество ходов (не клеток, а именно ходов). При этом ров и стены учитываются, кроме клетки ворот, которая является единственным путём, даже если ворота закрыты.<br><br>
		...
		[t]При расчётах ИИ считает, что [s]Стрелковые башни[/s] наносят 1 урон (это баг), поэтому башни предпочтут атаковать, например, отряд из 1 существа, чем из 10. На выбор цели влияют 2 фактора, рассчитываемые отдельно для каждого класса вражеских отрядов:<br><br>
	...
	<p>
		...
		[t]&bull; Если существо идёт вниз-влево, то оно старается сначала идти по диагонали, остаток по горизонтали.<br>
		[t]&bull; Если существо идёт вверх-влево, то оно идёт сперва по прямой, остаток по диагонали.<br>
	...
	<p>
		...
		[t]3.2 [m]Статуя Легиона[/m] (Повышает прирост всех существ на [s]50%[/s], с учётом базового прироста и дополнительного прироста от наличия [s]Цитадели[/s] или [s]Замка[/s], во всех городах игрока. Округление вниз. Герой с артефактом не обязан быть в городе на конец седьмого дня недели. Однако находясь в городе прирост будет повышен, благодаря действию составляющих [m]Статуи легиона[/m])<br><br>
		[t]4. [m]Грааль[/m] ([s]Храм Грааля[/s] повышает текущий прирост всех существ, с учётом всех дополнительных приростов, на [s]50%[/s] в городе, где он установлен)<br><br>
	...
	<p>
		...
		[t]Отдельно стоит упомянуть [s]Инферно[/s], ведь в случае установки [m]Грааля[/m] ([s]Бог огня[/s]) все "[s]Недели существ[/s]" отныне становятся "[s]Неделями Беса[/s]". Дополнительный прирост [m]Бесов[/m] и [m]Чертей[/m] составляет 15 единиц, не важно улучшен [s]Котёл бесов[/s] в городе или нет. Также не имеет значения, кто из игроков возведет это строение - действие распространяется на всех участников игры (в том числе и на компьютерных игроков). Помимо "[s]Недели Беса[/s]" все "[s]Месяцы существ[/s]" отныне становятся "[s]Месяцами Беса[/s]" (дополнительный прирост также составляет 15 единиц в неделю).<br><br>
	...
	${!m?'<p style="min-height: 260px">':''}
		...
		[t]&bull; Если наш дракон будет изначально находиться не "лицом" к цели ([s]жёлтый[/s]), то он развернётся перед перемещением, и атаки [s]4, 5[/s] и [s]6[/s] будут для него основными, атаки [s]1, 2[/s] и [s]3[/s] будут произведены с разворота, а атаки [s]7[/s] и [s]8[/s] будут дополнительными и дыхание нанесёт урон по клеткам [s]Б[/s] и [s]В[/s] соответственно.
	</p>
	${!m?'<p style="min-height: 260px">':''}
		...
		[t]&bull; Если наш дракон будет изначально находиться не "лицом" к цели ([s]жёлтый[/s]), то он развернётся перед перемещением, и атаки [s]4, 5[/s] и [s]6[/s] будут для него основными, атаки [s]1, 2[/s] и [s]3[/s] будут произведены с разворота, атаки [s]7, 8, 9[/s] и [s]10[/s] будут произведены по клетке [s]Г[/s] с дыханием по клеткам [s]Б, В, Ж[/s] или [s]З[/s] соответственно, атаки [s]11, 12, 13[/s] и [s]14[/s] будут произведены по клетке [s]Г[/s] с дыханием по клеткам [s]Ж[/s] или [s]З[/s] соответственно.
	</p>
	${!m?'<p style="min-height: 260px">':''}
	...
	<p${!m?' style="min-height: 260px"':''}>
		...
		[t]Одним из эффективных приёмов пополнения своих войск является способность [m]Адских отродий[/m] поднимать [m]Демонов[/m] из своих павших в бою существ.<br><br>
		[t]Поднятие демонов действует только на трупы живых существ, т.е. на [s]нежити[/s], [s]горгульях[/s], [s]элементалях[/s], [s]големах[/s] и [s]боевых машинах[/s] способность не работает.<br><br>
		...
		[t]Наличие артефактов, повышающих здоровье существ, идёт в расчёт числа призванных [m]Демонов[/m].<br><br>
	...
	<p${!m?' style="min-height: 260px"':''}>
		...
		[t]Таблица ниже демонстрирует некоторые пункты расчёта вероятности.
	</p>
	<table${!m?' class="compress"':''}>
	...
	<h2 id="mob_skills.9">Виверны-монархи, Морские змеи и Аспиды: Яд</h2>
	...
	<p${!m?' style="min-height: 260px"':''}>
		...
		[t]С [s]30%[/s] шансом накладывает на противника отравление. Под этим эффектом каждый раунд, включая момент наложения, здоровье цели будет снижаться на [s]10%[/s], но оно не может снизиться более, чем на [s]50%[/s] (округление вверх). Способность действует только на живых существ, за исключением драконов. Так как [s]Яд[/s] эквивалентен заклинаниям 3 уровня, то драконы невосприимчивы к нему. [s]Яд[/s] снимается заклинанием [m]Лечение[/m], но не может быть нейтрализован [m]Снятием заклинаний[/m] или [m]Антимагией[/m]. После воскрешения отряда, на который был наложен [s]Яд[/s], эффект пропадает, но сниженное здоровье так и остаётся сниженным.<br><br>
		[t]Пока активен сам эффект [s]Яда[/s], он виден на панели бафов и дебафов существа, однако по завершении трех раундов после наложения, здоровье существа остается сниженным, что можно увидеть только в его карточке характеристик, так как нет отдельного дефаба, отражающего сниженное здоровье. Этот эффект сниженного здоровья от [s]Яда[/s] также снимается заклинанием [s]Лечение[/s].
	</p>
	...
	<p${!m?' style="min-height: 260px"':''}>
		...
		[t]Способность срабатывает лишь раз за бой, т.е. если [m]Феникс[/m], восставший из пепла, будет вновь убит и затем воскрешён при помощи заклинания [m]Воскрешение[/m], то он потеряет возможность снова использовать способность в этом бою. Если на [m]Феникса[/m] используется заклинание [m]Жертва[/m], то отряд погибает без возможности воскрешения и его труп пропадает.<br><br>
	...
	<p>
		...
		[t]Если [m]Чародей[/m] загипнотизирован, то он использует случайную магию, как только к нему впервые перейдёт ход под управлением нового владельца, даже если он уже применял случайную магию под управлением изначального владельца.<br><br>
	...
	<p>
		[t]На ряду с атаками ближнего боя [m]Сказочный дракон[/m] также имеет возможность 5 раз за бой применить случайное заклинание: [m]Волшебная стрела[/m] ([s]Магия земли[/s], [s]10%[/s]), [m]Метеоритный дождь[/m] ([s]15%[/s]), [m]Ледяная молния[/m] ([s]11%[/s]), [m]Кольцо холода[/m] ([s]13%[/s]), [m]Огненный шар[/m] ([s]14%[/s]), [m]Инферно[/m] ([s]14%[/s]), [m]Молния[/m] ([s]11%[/s]) и [m]Цепная молния[/m] ([s]12%[/s]). Все заклинания действуют на [s]Продвинутом[/s] уровне магии, а их урон рассчитывается как при [s]Силе магии[/s] героя равной 5. На силу этих заклинаний действует также специализация героя, например, [m]Сказочный дракон[/m] под руководством [m]Солмира[/m] нанесет больший урон [m]Цепной молнией[/m], чем под руководством кого-либо другого.<br><br>
		[t]На урон влияют [s]Волшебство[/s] героя, наличие Сфер магии и ландшафт. Если [m]Сказочному дракону[/m] приказать [s]Ждать[/s], то он поменяет колдуемое заклинание.
	</p>
	...
	<p style="min-height: 150px">
		...
		[t]Базовая [s]Артиллерия[/s] даёт герою возможность управления [m]Баллистой[/m] и [s]50%[/s] шанс нанести выстрелом двойной урон.<br><br>
		[t]Продвинутая [s]Артиллерия[/s] даёт [s]75%[/s] шанс нанести выстрелом двойной урон.<br><br>
		[t]Экспертная [s]Артиллерия[/s] позволяет [m]Баллисте[/m] гарантировано наносить выстрелом двойной урон.<br><br>
		[t][m]Баллиста[/m] не участвует при захвате сокровищниц, где отрядам героя приходится занимать круговую оборону. [m]Баллиста[/m] также не участвует при защите города (если отстроен [s]Форт[/s]), но, вместо этого, навык [s]Артиллерии[/s] позволяет игроку управлять огнём [s]Стрелковых башен[/s].
	</p>
	...
	<p style="min-height: 150px">
		...
		[t]Базовая [s]Артиллерия[/s] даёт герою возможность управления [m]Пушкой[/m], исключаются варианты нанесения 0 единиц урона по укреплениям, повышаются шансы попадания по выбранной цели и вероятности нанесения большего урона (аналогично действию Базовой [s]Баллистики[/s]).<br><br>
		[t]Продвинутая [s]Артиллерия[/s] даёт [m]Пушке[/m] двойной урон по существам, повышаются шансы попадания по укреплениям и вероятность нанесения большего урона (аналогично действию Продвинутой [s]Баллистики[/s]).<br><br>
		[t]Экспертная [s]Артиллерия[/s] даёт [m]Пушке[/m] тройной урон по существам, повышаются шансы попадания по укреплениям и вероятность нанесения большего урона (аналогично действию Экспертной [s]Баллистики[/s]).<br><br>
	...
	<p style="min-height: 150px">
		...
		[t]Базовая [s]Первая помощь[/s] даёт герою возможность управления палаткой и увеличивает её эффективность до [s]1...50[/s] единиц здоровья.<br><br>
	...
	<p style="min-height: 150px">
		...
		[t][m]Подвода с боеприпасами[/m] не участвует при захвате сокровищниц, где отрядам героя приходится занимать круговую оборону, но боезапас стреляющих существ героя остаётся бесконечным. Кроме того, подвода не имеет своего хода.
	</p>
	`},
	{id: 'spells', text: `
	...
	<p>
		...
		[t]&bull; [s]Ров Башни[/s] не является [s]рвом[/s] в принципе. [s]Мины[/s] возле [s]стен[/s] никак не влияют на возможности передвижения и [m]Телепорта[/m]. Так что даже с [s]Базовой Магией воды[/s] можно телепортировать существ за [s]стены[/s] города, используя вышеописанные правила, по которым линия телепортации может проходить между фрагментами [s]стен[/s]. [s]Мина[/s] не активируется, если существо на неё телепортируется, но взрывается, если это существо пропустит ход или будет ждать.
	</p>
	...
	${!m? separateTables.spellsSpecialize : separateTables.spellsSpecializeM}
	`},
	{id: 'grail', text: `
	<h1>Грааль</h1>
	...
	<p>
		...
		[t]При расчётах ИИ считает, что [s]стрелковые башни[/s] наносят [s]1[/s] ед. урона (баг). Именно поэтому башни предпочтут атаковать, например, отряд из 1 существа, чем из 10. На выбор цели влияют 2 фактора, рассчитываемые отдельно для каждого класса вражеских отрядов:<br><br>
	...
	<p>
		...
		[t]&bull; Если пеший отряд попадает в [s]ров[/s], его движение в этом раунде заканчивается (подобно попаданию в [m]Зыбучие пески[/m]). Также существо теряет возможность атаковать, если наступило на клетку [s]рва[/s]. На летающих существ этот эффект не влияет. Двухгексовые существа получают эффект [s]рва[/s], находясь любой своей частью в нём. Пешее перемещение по клеткам [s]рва[/s] возможно только на расстояние в [s]1 клетку[/s]. [s]Ров[/s] одинаково действует как на осаждающих город существ, так и на обороняющихся.<br><br>
