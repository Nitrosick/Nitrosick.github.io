...
const mechanicsContent = [
	...
	<p>
		...
		<table>
			...
			<tr> <td class="left-align-cell" colspan="3">Во время тактической расстановки можно [s]Сдаться[/s] или [s]Сбежать[/s] с поля боя. Герои ИИ этим не пользуются.</td> </tr>
			...
			<tr>
				<td rowspan="2">Некромантия</td>
				<td rowspan="2" class="td-picture"><img height="75" data-src="images/secondary/necromancy${!m?'.png':'-m.jpg'}" alt="Иконка навыков"></td>
				<td rowspan="2">-</td>
