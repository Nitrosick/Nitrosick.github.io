...
const associations = [
	...
	{link: 'editor-page.html#1', 					keywords: ['Кнопки редактора', 'Панели редактора']},
	{link: 'editor-page.html#2', 					keywords: ['Работа с почвой и рельефом']},
	{link: 'editor-page.html#3', 					keywords: ['Размещение объектов', 'Редактирование объектов']},
	{link: 'editor-page.html#4', 					keywords: ['Настройки карты', 'Спецификации карты']},
	{link: 'editor-page.html#5', 					keywords: ['Идеи для карт', 'Приемы создания карт']},
	...
	{link: 'mechanics-page-3.html#mob_skills', 		keywords: ['Способности существ', 'Скиллы мобов', 'Особенности существ', 'Рут', 'Заклинания существ']},
	...
	{link: 'mechanics-page-4.html#secondary', 		keywords: ['Вторичные навыки', 'Умения героев', 'Скиллы героев']},
